...
export class AppComponent implements OnInit {
    ...
    switch (this.selectedAlgo) {
      case 'fcfs': {
        if(this.withArrival=='F'){
          ...
          this.arrivalTime=Object.assign([],this.processForm.get('arrivalTime').value)
          this.fcfs_at();
        }
        break;
      }
      ...
      case 'priority':{
        this.priority=Object.assign([],this.processForm.get('priority').value);
        if(this.withArrival=='F'){
          this.Priority()
        }
        else{
  ...
  sjf(){
   ...
   this.averageTurnaroundTime = this.averageTurnaroundTime / this.burstTime.length;
    }
